...
class ViewWindow:
    ...
    def __init__(self):
        ...
        self.win.title("| VIEWING STUDENT DETAILS | LIBRARY MANAGEMENT SYSTEM |")
    ...
    def add_frame(self):
        ...
        self.label = Label(self.frame, text="VIEW STUDENT DETAILS", fg='black')
        self.label.config(font=("Poppins", 20, 'underline bold'))
        self.label.place(x=275, y=30)
        ...
        self.tr.heading('#3', text='SEMESTER')
        ...
        self.tr.heading('#5', text='PHONE_NO')
